...
Пока что код скопировала - разобралась, как работает, но на написание своего пока времени не хватило 
сдаю сейчас для отметки о сдаче 
планирую написать свой до 23 июня включительно
...
